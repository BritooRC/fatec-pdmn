          ...
          <div className="col-sm-12 col-md-8 col-xxl-6">
            {
              ...
              <Loading
              mensagem="por favor responda a mensagem de solicitação de localização" />
              :
              this.state.mensagemDeErro ?
                <p className="border rounded p-2 fs-1 textcenter">
                  É preciso permitir acesso a localização para que seja possível mostrar a sua estação climática
                </p>
                :
                <EstacaoClimatica
